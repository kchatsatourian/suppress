FROM golang:1.23.4-alpine AS certificates
...
FROM golang:1.23.4-alpine AS suppress
...
LABEL \
    org.opencontainers.image.description="Supress is a simple RSS bot for Telegram written in Go." \
